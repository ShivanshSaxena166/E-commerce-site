        ...
        <List>
          ...
          <ListItem
            ...
            nestedItems={[
              ...
              <Checkbox className="checkbox" label="Windows 10 Pro" name="os" value="Windows 10 Pro" checked={checked.includes('Windows 10 Pro')} onCheck={this.handleCheck} />,
              <Checkbox className="checkbox" label="Windows 10 Home" name="os" value="Windows 10 Home" checked={checked.includes('Windows 10 Home')} onCheck={this.handleCheck} />,
